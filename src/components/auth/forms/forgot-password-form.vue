<template>
    ...
    >
        ...
        >
            ...
            <span v-else>{{ localization.FORGOT_PASSWORD_ACTION }}</span>
        </button>
    </form>
</template>
...
if (!context) {
    throw new Error('ForgotPasswordForm must be used within AuthUIProvider')
}
...
const onSubmit = handleSubmit(async (values) => {
    try {
        ...
        toast({
            variant: 'success',
            message: localization.value.FORGOT_PASSWORD_EMAIL
        })
